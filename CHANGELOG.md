...
> Entries up to 0.18.0 are inherited from the upstream Veloren project, which
> LemonCraft derives from. Changes starting with the divergence are listed
> under LemonCraft's own releases.
