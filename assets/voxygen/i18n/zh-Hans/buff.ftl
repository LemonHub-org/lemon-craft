...
buff-stormchaser = 追风者
    .desc = 你陶醉于暴力之中，当你的箭矢命中时，你的攻击和移动会变得更快。
buff-ardenthunt = 炽热狩猎
    .desc = 你的狂热使箭矢对特定目标更具杀伤力，但对其他目标的伤害会降低。
buff-ignitearrow = 引燃之箭
    .desc = 你已引燃下一支箭矢，命中目标时会使它燃烧；若以特定方式射出，还可能引发爆炸。
buff-freezearrow = 冰霜之箭
    .desc = 你已冻结下一支箭矢，命中目标时会使它冻结；若以特定方式射出，还可能爆发出冰霜之云。
buff-drencharrow = 剧毒之箭
    .desc = 你已为下一支箭矢浸上剧毒，命中目标时会使其中毒；若以特定方式射出，还可能爆发出剧毒之云。
buff-joltarrow = 电击之箭
    .desc = 你已为下一支箭矢充上静电，命中目标时会释放电弧；若以特定方式射出，还可能被目标吸引。
