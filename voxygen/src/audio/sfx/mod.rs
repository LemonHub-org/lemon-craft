...
//! [SfxEvent](../../../lemoncraft_common/event/enum.SfxEvent.html) item, with
...
//! [SfxEvent](../../../lemoncraft_common/event/enum.SfxEvent.html)
//! documentation provides links to those variables, some examples are provided
//! her for longer items:
//!
//! ```ignore
//! // An inventory action
//! Inventory(Dropped): (
